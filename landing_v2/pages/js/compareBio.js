var imgHeight = 700, imgWidth = 965,      // Image dimensions (don't change these)
    width =  1050, height = 950,             // Dimensions of cropped region
    translate0 = [0,-15], scale0 = 1;  // Initial offset & scale [x,y]
...
comContainer.append("image")
    ...
    .attr("xlink:href", "img/Chart_of_biography.jpg");
