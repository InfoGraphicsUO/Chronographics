...
function clearSelection(bool){
	console.log("clearing - functions")
	// click selection labels
	d3.select("#place_label").text("")
	d3.select("#power_label").text("")
	d3.select("#year_label").text("")
	d3.select("#power_map").text("Empire: click map or chart to select")
	d3.select("#place_map").text("Place: click map or chart to select")
